...
def computer_move(piles):
    """
    Given a list of piles, return the pile and number of stones to remove to ensure that the computer wins the game.
    The strategy is to always maintain an even XOR sum of the piles,
    ...
    if xor == 0:
        ...
        # Find the highest bit in the XOR sum and remove stones from the pile # that has a 1 in that position
        highest_bit = 1
